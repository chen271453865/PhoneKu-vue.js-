<template>
    <div id="app">
        <mt-header :title="biaot">
            <router-link to="/" slot="left">
                <mt-button icon="back">返回</mt-button>
            </router-link>
        </mt-header>
        <div class="transactionData">
            <p><strong>55000.00</strong></p>
            <div class="dataTitle">
                <small>今开</small>
                <small>最低</small>
                <small>最高</small>
            ...
            <div class="dataContent">
                <small class="red">55000.00</small>
                <small class="green">50000.00</small>
                <small class="red">100000.00</small>
                <small class="red">11.2%</small>
            </div>
            <div class="dataTitle">
                <small>成交量</small>
                <small>成交额</small>
            ...
            <div class="dataContent pdBottom0">
                <small class="red">37.2万</small>
                <small class="red">1.64亿</small>
                <small class="red">12.00亿</small>
                <small class="red">6.00亿</small>
            </div>
        </div>
        <!-- <chart :id="id" :option="option"></chart> -->
        <!-- <chart id="container" class="container"></chart>
...
import HighchartsComponent  from '@/components/index/HighchartsComponent'
    ...
    methods: {
        ...
        createChart() {
            ...
            this.$fetch('https://data.jianshukeji.com/jsonp?filename=json/aapl-ohlcv.json&callback=?', (data) => {
                var ohlc = [],
                    volume = [],
